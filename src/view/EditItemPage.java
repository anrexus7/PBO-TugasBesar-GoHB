...
public class EditItemPage extends JFrame {
    public EditItemPage(Item datum, int restoId) {
        showEditItem(datum, restoId);
    }

    private void showEditItem(Item datum, int restoId) {
        ...
        gbc.gridx++;
        JTextField price = new JTextField(String.valueOf(datum.getHarga()),20);
        ...
        gbc.gridx++;
        JTextField stock = new JTextField(String.valueOf(datum.getStock()),20);
        ...
        TypeI.setSelectedItem(datum.getKategori());
